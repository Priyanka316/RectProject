...
import { Articles } from './MainData';
import {Bottombox} from './MainData';
import { bottom } from './MainData';
  ...
  return (
    <>
      ...
      <div className="content">
        ...
        <div className="img3">
        <img src={require('../Images/code.png')} alt="" className='image3'/>
        </div>
        <div className='small'>
        ...
        <div className="clap">
            <img src={require('../Images/rythm.png')} alt="" className='image4' />
    ...
    <div className="bottomdown">
    {
      ...
      <div className="side">
            <div>
            <img src={require('../Images/rythm.png')} alt="" className='sideimg1' />
