...
import { Bollyfirst, Bollysecond } from "./MainData";
import { mainTech,mainThird} from "./MainData";
          ...
          <div className="box">
            ...
            <div className="boxleftbolly">
                ...
                <div className="toppost">
                    ...
                    <h3 className="top1text">'Technologies'Earth Observation: Disruptive ..'</h3>
                    {/* <span className="travel">Travel</span>
                    <span className="travel1">/ August 27 2020</span> */}
                    </div>
                    <hr className="hr6" />
                    {
